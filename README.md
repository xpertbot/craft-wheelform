...
`beforeValidate` Event, this allows developers to validate the values and add custom errors. skipping the plugin validation all together, this happens before the basic plugin vaidation.
